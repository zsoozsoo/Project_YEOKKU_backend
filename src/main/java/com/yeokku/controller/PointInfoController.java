...
public class PointInfoController {
	...
	@GetMapping("/movie")
	public void PointMovie() {
		
	        try {
//	            String apiUrl = "http://api.koreafilm.or.kr/openapi-data2/wisenut/search_api/search_xml2.jsp?collection=kmdb_new2&"
//	            		+ "detail=N&director=%EB%B0%95%EC%B0%AC%EC%9A%B1&ServiceKey=7Z770626Z954T1WCK808";
	        	...
	        	//상영 국가
	        	urlBuilder.append("&nation="+"대한민국"); 
	        	//서비스 키
	        	urlBuilder.append("?" + URLEncoder.encode("7Z770626Z954T1WCK808","UTF-8"));
	        	//상영년도
